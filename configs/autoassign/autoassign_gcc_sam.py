# Config pour l'entraînement sur dataset_sam_1.0 (8 classes)
_base_ = [
    '../../_base_/datasets/custom_dataset_sam.py',
...
model = dict(
    ...
    bbox_head=dict(
        type='AutoAssignHead',
        num_classes=8,      # dataset_sam_1.0 : 8 classes
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
