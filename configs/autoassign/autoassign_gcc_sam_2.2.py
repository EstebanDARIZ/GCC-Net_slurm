# Config pour l'entraînement sur dataset_sam_2.2 (8 classes, Tuna retiré)
_base_ = [
    '../../_base_/datasets/custom_dataset_sam_2.2.py',
...
model = dict(
    ...
    bbox_head=dict(
        type='AutoAssignHead',
        num_classes=8,      # dataset_sam_2.2 : 8 classes (Tuna retiré)
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Retinex', model='MSR', sigma=[30, 150, 300], restore_factor=2.0, color_gain=6.0, gain=128.0, offset=128.0),
            dict(type='Normalize', **img_norm_cfg),
            dict(type='Pad', size_divisor=32),
