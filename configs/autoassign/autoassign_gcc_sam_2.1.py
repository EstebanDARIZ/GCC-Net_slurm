# Config pour l'entraînement sur dataset_sam_2.1 (9 classes)
_base_ = [
    '../../_base_/datasets/custom_dataset_sam_2.1.py',
...
model = dict(
    ...
    bbox_head=dict(
        type='AutoAssignHead',
        num_classes=9,      # dataset_sam_2.1 : 9 classes
        in_channels=256,
        stacked_convs=4,
        feat_channels=256,
